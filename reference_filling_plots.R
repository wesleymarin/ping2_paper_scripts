...
referenceDirectory <- '/home/wmarin/PING_projects/reference_filling_testing'

alignedFilledReferencePath <- normalizePath(file.path(referenceDirectory,'KIR_gen_onelines_aligned_filled.fasta'),mustWork=T)
