...
setwd('/home/LAB_PROJECTS/PING2_PAPER/')

source('PING2/Resources/gc_functions.R')
source('figure_scripts/support/general_functions.R')
...
kirReferenceFasta <- 'PING2/Resources/gc_resources/filled_kir_reference/KIR_gen_onelines_filled.fasta'
